...
lowp float ieeDiagFpspriteEasuDeltaMarker()
{
    return 0.0;
}
...
void main()
{
    ...
    lowp vec3 heat = uhDeltaHeat(baseTex.rgb, easuRgb) + vec3(ieeDiagFpspriteEasuDeltaMarker());
    gl_FragColor = vec4(heat, baseTex.a);
}
